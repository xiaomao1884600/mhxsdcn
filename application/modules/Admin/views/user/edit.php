		...
		<table class="table table-striped table-bordered clearfix">
				<?php if (empty($userInfo)):?>
					...
					<tr>
						...
						<td><div class="col-xs-3"><?php if ($userInfo):?><?php echo $userInfo['email'];?><?php else:?><input type="text" name="username" class="form-control" value="" maxlength="16" required /><?php endif;?></div></td>
					</tr>
					<tr>
						<td width="15%">年龄</td>
				...
				<?php endif;?>
					<tr>
						...
						<td><div class="col-xs-3"><?php if ($userInfo):?><?php echo $userInfo['email'];?><?php else:?><input type="text" name="email" class="form-control" value="" maxlength="30" required /><?php endif;?></div></td>
					</tr>
					<tr>
						<td width="15%">用户组</td>
						<td>
					...
					<tr>
						...
						<td><div class="col-xs-3"><input type="password" name="password" class="form-control" maxlength="16" value="" required /></div></td>
					</tr>
					<tr>
						<td width="15%">确认密码<?php if (empty($userInfo)):?> <span class="required">*</span><?php endif;?></td>
						<td><div class="col-xs-3"><input type="password" name="repassword" class="form-control" maxlength="16" value="" required /></div></td>
					</tr>
					<tr>
